...
-- CreateIndex
CREATE UNIQUE INDEX "invites_organizations_id_userId_key" ON "invites"("organizations_id", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "members_organization_id_userId_key" ON "members"("organization_id", "userId");
...
-- AddForeignKey
ALTER TABLE "invites" ADD CONSTRAINT "invites_organizations_id_fkey" FOREIGN KEY ("organizations_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
